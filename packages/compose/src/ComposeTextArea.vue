<docs>
Provides the means to review and edit a PROformajs component's attribute with an html textarea field
...
* rows - number of rows (optional - defaults to 6)
...
<script>
import { AttributeMixin } from './attribute'
